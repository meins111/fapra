...
QT_MOC_LITERAL(4, 30, 15), // "percentProgress"
QT_MOC_LITERAL(5, 46, 11), // "parsingDone"
QT_MOC_LITERAL(6, 58, 11), // "successFlag"
QT_MOC_LITERAL(7, 70, 19), // "pathfindingProgress"
QT_MOC_LITERAL(8, 90, 15) // "pathfindingDone"

    },
    "Slaver\0parseProgress\0\0uint8_t\0"
...
void Slaver::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->parseProgress((*reinterpret_cast< uint8_t(*)>(_a[1]))); break;
        case 1: _t->parsingDone((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 2: _t->pathfindingProgress((*reinterpret_cast< uint8_t(*)>(_a[1]))); break;
        ...
        {
            typedef void (Slaver::*_t)(uint8_t );
...
// SIGNAL 0
void Slaver::parseProgress(uint8_t _t1)
{
...
// SIGNAL 2
void Slaver::pathfindingProgress(uint8_t _t1)
{
    void *_a[] = { Q_NULLPTR, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
